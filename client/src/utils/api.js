...
export const api = {
  ...
  dropStudent: (studentId, data) => request(`/students/${studentId}/drop`, { method: 'POST', body: JSON.stringify(data) }),
  dropStudentPreview: (studentId, data) => request(`/students/${studentId}/drop-preview`, { method: 'POST', body: JSON.stringify(data) }),
  reEnrollStudent: (studentId) => request(`/students/${studentId}/re-enroll`, { method: 'POST' }),
