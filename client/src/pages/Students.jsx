  ...
  return (
    <div>
      <TopBar title="Students" onMenuClick={onMenuClick}>
        ...
        <button onClick={openAdd} className="bg-brand-steel hover:bg-brand-teal text-white px-4 py-1.5 rounded-lg text-sm font-medium transition-colors whitespace-nowrap">
          + Add Student
        </button>
      </TopBar>
                  ...
                  <tr key={s.student_id} className="border-b border-brand-border/50 hover:bg-brand-light/50">
                    ...
                    <td className="px-4 py-2">
                      <div className="flex items-center gap-1">
                        ...
                        <button onClick={() => openEdit(s)} className="text-brand-slate hover:text-status-warning p-1" title="Edit">
                        ...
                        <button onClick={() => setDeleteTarget(s.student_id)} className="text-brand-slate hover:text-status-danger p-1" title="Delete">
